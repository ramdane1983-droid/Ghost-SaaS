    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8', color: '#1A1208' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '8px', letterSpacing: '3px', color: '#C4B99A', fontFamily: 'Montserrat', fontWeight: 500 }}>
                AUTHORITY ENGINE
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <span style={{ fontSize: '12px', color: '#A09070', fontFamily: 'Montserrat', fontWeight: 300, maxWidth: '160px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {email}
            </span>
            <button onClick={handleLogout} className="btn-outline" style={{
              padding: '7px 16px', borderRadius: '8px',
              fontSize: '11px', fontFamily: 'Montserrat', fontWeight: 500,
              color: '#7A6840', cursor: 'pointer', letterSpacing: '1px',
            }}>
              LOGOUT
            </button>
          </div>
      ...
      <main style={{ maxWidth: '820px', margin: '0 auto', padding: '60px 24px 120px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }} className="fade-up">
          <div className="gold-badge" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', marginBottom: '24px' }}>
            ✦ YOUR WORDS. AMPLIFIED.
          </div>
          <h1 style={{
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: '58px', fontWeight: 400, lineHeight: 1.1,
            color: '#1A1208', marginBottom: '16px', letterSpacing: '-0.5px',
          }}>
            Transform Your Voice<br />
            <em style={{ color: '#C9A84C', fontWeight: 300 }}>Into Authority</em>
          </h1>
        ...
        <div className="card fade-up-2" style={{ padding: '36px', marginBottom: '20px' }}>
          ...
          >
            ...
            <div style={{
              ...
              background: file ? 'linear-gradient(135deg, #D4AF37, #A07820)' : 'linear-gradient(135deg, #F5F2EC, #EDE8DE)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              margin: '0 auto 20px', fontSize: '30px',
              boxShadow: file ? '0 8px 28px rgba(201,168,76,0.35)' : '0 4px 12px rgba(26,18,8,0.06)',
              transition: 'all 0.4s ease',
            }}>
              {file ? '✓' : '🎙'}
            </div>
            <div style={{
              ...
              color: file ? '#C9A84C' : '#1A1208', marginBottom: '8px',
            }}>
        ...
        {transcript && (
          <div className="card fade-up" style={{ padding: '24px 28px', marginBottom: '28px' }}>
            ...
            <p style={{ fontSize: '13px', color: '#7A6840', lineHeight: 1.8, fontFamily: 'Montserrat', fontWeight: 300 }}>
              {transcript}
            </p>
          </div>
        )}
        ...
        {angles && (
          <div style={{ marginBottom: '72px' }} className="fade-up">
            ...
            <div style={{
              ...
              background: '#F5F2EC', padding: '4px',
              borderRadius: '14px 14px 0 0',
              border: '1px solid #EDE8DE', borderBottom: 'none',
            }}>
              {Object.entries(ANGLE_CONFIG).map(([key, config]) => (
                <button key={key} onClick={() => setActiveAngle(key)} className="tab-btn" style={{
                  flex: 1, padding: '13px 8px',
                  background: activeAngle === key ? '#FFFFFF' : 'transparent',
                  border: 'none', borderRadius: '10px',
                  color: activeAngle === key ? config.color : '#A09070',
                  fontSize: '9px', letterSpacing: '2px',
                  fontFamily: 'Montserrat', fontWeight: 600, cursor: 'pointer',
                  boxShadow: activeAngle === key ? '0 2px 8px rgba(26,18,8,0.08)' : 'none',
                }}>
            ...
            <div className="card" style={{ borderRadius: '0 0 20px 20px', padding: '32px' }}>
              <span style={{
                ...
                background: '#F5F2EC', borderRadius: '100px',
                fontSize: '9px', color: '#A09070', letterSpacing: '2px',
                fontFamily: 'Montserrat', fontWeight: 500, marginBottom: '20px',
              }}>
                {ANGLE_CONFIG[activeAngle].description}
              </span>
              <p style={{
                fontSize: '16px', lineHeight: 1.9, color: '#2A1E0A',
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button onClick={() => handleSave(activeAngle)} disabled={saved[activeAngle]}
                  className={saved[activeAngle] ? '' : 'btn-gold'}
                  style={{
                    flex: 1, padding: '13px', borderRadius: '12px',
                    border: 'none', fontSize: '10px', letterSpacing: '2px',
                    fontFamily: 'Montserrat', fontWeight: 600,
                    color: saved[activeAngle] ? '#A09070' : '#2A1800',
                    background: saved[activeAngle] ? '#F5F2EC' : undefined,
        ...
        <div className="fade-up-3">
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
            <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px', fontWeight: 500, color: '#1A1208', letterSpacing: '1px' }}>
              The Vault
            </span>
          ...
          {history.length === 0 ? (
            <div style={{
              ...
              background: '#FFFFFF', border: '2px dashed #EDE8DE', borderRadius: '20px',
            }}>
              <div style={{ fontSize: '40px', marginBottom: '16px', opacity: 0.15 }}>◈</div>
              <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '20px', fontWeight: 400, color: '#1A1208', marginBottom: '8px' }}>
                Your vault awaits
              </div>
              <div style={{ fontSize: '12px', color: '#C4B99A', fontFamily: 'Montserrat', fontWeight: 300 }}>
              ...
              {history.map((post) => (
                <div key={post.id} className="vault-card" style={{ padding: '22px 28px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                    ...
                    <div style={{ flex: 1 }} />
                    <span style={{ fontSize: '11px', color: '#C4B99A', fontFamily: 'Montserrat' }}>
      ...
      {showUpgradeModal && (
        <div style={{
          ...
          <div className="card fade-up" style={{ padding: '52px 44px', maxWidth: '440px', width: '90%', textAlign: 'center' }}>
            ...
            <h2 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontSize: '32px', fontWeight: 400, color: '#1A1208',
            ...
            <div style={{
              padding: '20px', background: 'linear-gradient(135deg, #FFFEF9, #FFF8E6)',
            ...
            <button onClick={() => setShowUpgradeModal(false)} style={{
              background: 'none', border: 'none', color: '#C4B99A',
              fontSize: '12px', fontFamily: 'Montserrat', cursor: 'pointer',
            }}>
              maybe later
            </button>
          </div>
      ...
      {/* FOOTER */}
      <footer style={{
        borderTop: '1px solid #EDE8DE', padding: '24px 32px',
